...
const Footer = () => {
  return (
    <footer className="bg-[#8A7C56] text-white py-16">
      <div className="container mx-auto max-w-[90vw] grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <ul className="space-y-4">
            ...
            <li className="flex gap-2 items-center">
              ...
              <a href="tel:+191062685255" className="hover:text-gray-900">+1 910-626-85255</a>
            </li>
            <li className="flex gap-2 items-center">
              <FaEnvelope className="text-lg" />
              <a href="mailto:contact@hello.com" className="hover:text-gray-900">contact@hello.com</a>
            </li>
          </ul>
        </div>
